    ...
    items: [
      {
        ...
        icon: BarChart2,
        children: [
          { id: "pald", label: "pALD & Overview", href: "/dashboard-analytics", icon: BarChart2 },
          { id: "viral-load", label: "Viral Load & IAC/LLV", href: "/dashboard-analytics/viral-load", icon: TrendingUp },
          { id: "ahd", label: "AHD Screening", href: "/dashboard-analytics/ahd", icon: Activity },
          { id: "commodities", label: "Commodities & DSD/MMD", href: "/dashboard-analytics/commodities", icon: Package },
          { id: "capacity", label: "Capacity & Retention", href: "/dashboard-analytics/capacity", icon: Users2 },
          { id: "overview", label: "Guide", href: "/dashboard-analytics/overview", icon: HelpCircle },
        ],
      },
    ],
  },
